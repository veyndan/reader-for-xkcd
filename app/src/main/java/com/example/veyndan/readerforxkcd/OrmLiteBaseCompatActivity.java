...
/**
 * Class is a copy of {@link com.j256.ormlite.android.apptools.OrmLiteBaseActivity} but extends
 * AppCompatActivity instead of Activity for better backwards compatibility.
 *
 ...
 */
public abstract class OrmLiteBaseCompatActivity<H extends OrmLiteSqliteOpenHelper> extends AppCompatActivity {

    private volatile H helper;
    private volatile boolean created = false;
    private volatile boolean destroyed = false;
    private static Logger logger = LoggerFactory.getLogger(OrmLiteBaseCompatActivity.class);
